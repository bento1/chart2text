...
@registry.register_builder("chart2text_warmup")
class Chart2TextWarmUpBuilder(BaseDatasetBuilder):
    train_dataset_cls = SummaryChartDataset
    DATASET_CONFIG_DICT = {
        "default": "configs/datasets/chart2text_warmup/default.yaml",
    }
    ...
    def build_datasets(self):
        ...
        datasets['train'] = dataset_cls(
            ...
            root_path=build_info.root_path,
        )
